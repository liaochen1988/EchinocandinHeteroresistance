for path in */; do
    ...
    # run haplotypecaller
    # gatk 4.1.9.0 does not support --genotyping-mode. use --alleles triggers force calling
    # make sure to include "-ERC GVCF"
    ../$2/gatk --java-options "-Xms4g -Xmx256g" HaplotypeCaller \
      -R ../$3/C_parapsilosis_CDC317_current_chromosomes.fasta \
      -I $bamfile \
